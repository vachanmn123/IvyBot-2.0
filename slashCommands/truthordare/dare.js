...
module.exports = {
  ...
  description: "Gives a Dare", //the command description for Slash Command Overview
  cooldown: 1,
  memberpermissions: [], 
  requiredroles: [], 
  alloweduserids: [], 
  options: [
        ...
        {"User": { name: "user", description: "The reciever who will get the dare", required: false }},
  ],
